# Bricks.Business.Currency

Пакет реализует модель денежных единиц и механизм формирования курса валют на
основании имеющейся информации о курсе базовой валюты.
...
[исходные коды]: https://github.com/Bashka/bricks_business_currency/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_business_currency/issues
